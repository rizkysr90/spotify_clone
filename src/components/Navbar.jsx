      ...
      <ul className="navbar-nav">
        <li className="nav-item">
          <Link to="" className="nav-link">
            ...
            <svg
              ...
              viewBox="0 0 448 512"
              className="svg-inline--fa fa-angle-double-right fa-w-14 fa-5x logo"
            >
        ...
        <li className="nav-item">
          <a href="/" className="nav-link">
            ...
            <span className="link-text">All Songs</span>
          </a>
        </li>
        <li className="nav-item">
          <a href="/pages/fav_songs.html" className="nav-link">
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fad"
            ...
            <span className="link-text">Most Played</span>
          </a>
        </li>
        <li className="nav-item">
          <Link to="/" className="nav-link">
        ...
        <li className="nav-item" id="themeButton">
          <Link href="/" className="nav-link">
            ...
            <span className="link-text">Rizki SR</span>
          </Link>
        </li>
      </ul>
    </nav>
